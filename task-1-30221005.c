 ...
 *               facilitates the act of First-Come-First-Serve process scheduling
 ...
 * First-Come-First-Serve process scheduling through calls to other functions
 ...
 * perform the scheduling through the fcfs_scheduler() function, write the results
...
int main(int argc, char *argv[])
{
	...
	fcfs_scheduler(process_list, num_processes);
